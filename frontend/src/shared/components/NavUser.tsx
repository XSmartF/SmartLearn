    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className="px-3 py-3 mb-2 flex items-center gap-3 rounded-lg bg-sidebar-accent/30">
          <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white text-sm font-bold overflow-hidden shadow-sm">
            {user.avatarUrl ? (
        ...
        <DropdownMenuItem asChild>
          <Button 
            variant="ghost" 
            className="w-full justify-start gap-3 text-sm font-medium text-destructive hover:bg-destructive/10 hover:text-destructive" 
