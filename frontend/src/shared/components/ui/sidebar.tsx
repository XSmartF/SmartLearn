...
// useSidebar moved to its own hook file for persistence & fast-refresh friendliness
...
function SidebarProvider({ className, style, children, ...props }: React.ComponentProps<'div'>) {
  // Keyboard shortcut support using redux state
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-full w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex overflow-hidden",
          side === "left"
...
export {
  ...
  SidebarSeparator,
  SidebarTrigger,
  // useSidebar exported from hooks/useSidebar now
}
