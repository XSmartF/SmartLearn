...
export interface AuthState {
  user: (UserProfile & { [key: string]: unknown }) | null;
  loading: boolean;
  error: string | null;
...
const slice = createSlice({
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(signIn.fulfilled, (s,a)=> { s.loading=false; s.user=a.payload as unknown as (UserProfile & { [key: string]: unknown }); })
      ...
      .addCase(signUp.fulfilled, (s,a)=> { s.loading=false; s.user=a.payload as unknown as (UserProfile & { [key: string]: unknown }); })
      ...
      .addCase(signInWithGoogle.fulfilled, (s,a)=> { s.loading=false; s.user=a.payload as unknown as (UserProfile & { [key: string]: unknown }); })
