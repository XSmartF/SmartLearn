...
import type { Card as EngineCard, LibraryMeta, LibraryShare } from '@/lib/models'
import type { AccessRequestDoc } from '@/lib/repositories/UserRepository'
            ...
            <Dialog open={!!editCardId} onOpenChange={(o)=>{ if(!o) { setEditCardId(null);} }}>
              <DialogContent>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={async ()=>{ if(!editCardId) return; const cid = editCardId; const prevSnapshot = cards;
